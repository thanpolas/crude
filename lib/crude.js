 ...
 */
var Crude = module.exports = CeventEmitter.extend(function(route, controller) {
  if (!(this instanceof Crude)) {
    return new Crude(route, controller);
  }

  if (typeof route !== 'string') {
    throw new TypeError('First argument should be a string represeting route');
  }
