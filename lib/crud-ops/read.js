...
Read.prototype.setupReadList = function() {
  ...
  if (this.base.opts.pagination) {
    this.base.readList.push(this.pagination.paginate(this.base));
    this.base.readList.push(this.readListResults.bind(this));
  } else {
...
Read.prototype.readOne = Promise.method(function(req, res) {
  ...
  return this.base.entity[this.base.opts.entityReadOne](query)
    ...
    .catch(this._handleReadError.bind(this, req, res, this.base.view.view));
});
