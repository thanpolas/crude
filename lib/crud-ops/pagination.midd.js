...
Pagination.prototype._paginateMiddleware = Promise.method(function(req, res,
  ...
  if (!this._checkOwnUser(query, req)) {
 ...
 *
 * @param {Object} res The normalized query.
 * @param {Object} req The request Object.
 */
Pagination.prototype._checkOwnUser = function(query, req) {
...
Pagination.prototype.getLimitAndCount = function(query, skip, limit) {
  return Promise.all([
    this.crude.controller.readLimit(query, skip, limit),
    this.crude.controller.count(query),
  ]);
};
